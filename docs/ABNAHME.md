...
# Plex-Episodenzuordnung: Nachtrag

Die Live-Meldung „Unvollständige Plex-Episodenzuordnung“ zeigte eine zu strenge Prüfung der `allLeaves`-Antwort. Zahlen als Text werden jetzt normalisiert; fehlende Nummern über Episoden- und Staffelmetadaten aufgelöst. Unauflösbare Serien behalten ihren bisherigen Zuordnungs- und Verfügbarkeitsstand samt Prüfdatum, statt den gesamten Scan abzubrechen. Warnungen nennen Serie, Bibliothek, Episode und fehlende Felder. Tests prüfen die Rückfallwege, Specials, fehlende/ungültige Nummern und den Schutz des betroffenen Serienbaums bei gleichzeitigem Abgleich anderer Titel. Der konkrete auslösende Plex-Datensatz lag nicht vor; die neue Diagnose macht ihn bei erneutem Auftreten sichtbar.
